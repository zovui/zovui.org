        ...
        data: [
            {
                ...
                explain: 'Checkbox组件单独使用并且选中值发生改变时触发'
            }
        ]
    }
]
        ...
        data: [
            {
                ...
                default: '-',
                values: '-',
                explain: '原生checkbox的name值，不设置时会自动生成'
            },
            {
                prop: 'value',
                type: 'Array',
            ...
            },
            {
                ...
                default: 'false',
                values: '-',
                explain: '是否禁用所有当前CheckboxGroup下的checkbox'
            },
            {
                prop: 'vertical',
                type: 'boolean',
...
export default {
    ...
    data() {
        return {
            examples: [Base, WithCheckboxGroup],
