<template>
    <ComponentExampleContainer
        ...
        desc="单选框；主要用于一组可选项单项选择，或者单独用于切换到选中状态。"
        :apiList="apiList"
    >
        <ComponentExample
...
const RadioApi = [
    ...
    },
    {
        ...
        data: [
            {
                event: 'on-change',
                callbackParam: '当前选中项的值',
                explain: 'Radio组件单独使用并且选中值发生改变时触发'
            }
        ]
    }
]
        ...
        data: [
            {
                ...
                default: '-',
                values: '-',
                explain: '原生radio的name值，不设置时会自动生成'
            },
            {
                prop: 'value',
                type: 'string|number|boolean|object',
            ...
            },
            {
                ...
                default: 'false',
                values: '-',
                explain: '是否禁用所有当前RadioGroup下的Radio'
            },
            {
                prop: 'border',
                type: 'boolean',
            ...
            },
            {
                ...
                required: 'false',
                default: 'outline',
                values: ['outline', 'solid'].join(' | '),
                explain: '按钮样式，在border为true或group为true时生效'
            },
            {
                prop: 'vertical',
                type: 'boolean',
...
export default {
    ...
    data() {
        return {
            examples: [Base, Name, WithRadioGroup, Border, Connected, Disabled],
