...
import Status from '@/examples/progress/Status.vue?demo'
...
const ProgressApi = [
    {
        ...
        data: [
            ...
            },
            {
                ...
                required: 'false',
                default: '8',
                values: ['normal', 'active', 'success', 'exception'].join(
                    ' | '
                ),
                explain: '进度条状态'
            }
