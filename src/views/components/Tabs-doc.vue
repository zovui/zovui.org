	...
	data() {
		return {
			...
			tabsPropsData: [
				{
					property: 'activeId',
					explain: 'v-model对应的prop，激活的tab对应的id',
					type: 'String',
					default: '第一个tabs的id'
				},
				{
					property: 'type',
					explain: 'tabs类型, 可选border-card | card',
					type: 'String',
					default: 'border-card'
				},
				{
				...
				},
				{
					...
					explain: 'tab关闭时的钩子，可阻止关闭行为',
					type: 'Function',
					default: 'undefined'
				},
				{
					property: 'beforeChange',
					explain: 'tab切换时的钩子，可阻止切换tab的行为',
					type: 'Function',
					default: 'undefined'
				},
				{
					property: 'preventDefaultRemove',
					explain: '可阻止默认的删除行为',
					type: 'Boolean',
					default: 'false'
				}
			...
			tabsEventsData: [
				{
					...
					explain: '当tabs切换时触发, v-model对应的事件。',
					returnValue: 'id值，当前tabs的id值'
				},
				{
					eventsName: 'on-add',
					explain: '当添加tab时触发。',
					returnValue: '添加pane的id值'
				},
				{
					eventsName: 'on-remove',
					explain: '当删除tab时触发。',
					returnValue: '删除pane的id值'
				},
				{
					eventsName: 'on-prev',
					explain: '当tabs的nav可滚动时，点击上一页时触发。',
					returnValue: '无'
				},
				{
					eventsName: 'on-next',
