<template>
    <ComponentExampleContainer
        component-name="Page 布局"
        desc="分页器，多用于信息列表，多页表格数据的展示控制。"
        :api-list="apiList"
    >
        <ComponentExample
...
const PageApi = [
    {
        ...
        data: [
            ...
            {
                props: 'page-size-opts',
                type: 'Array',
                required: 'false',
                default: '[{value:10},{value:20},{value:30},{value:40}]',
                values: '-',
                explain: '每页条数切换的配置'
            },
            {
...
export default {
    ...
    data() {
        return {
            examples: [Base, ShowTotalPage, Elevator, Sizer],
            apiList: [...PageApi]
        }
    }
}
