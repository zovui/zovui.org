<template>
    <ComponentExampleContainer
        component-name="Tooltip 气泡提示"
        desc="提示气泡框，在鼠标悬停时显示，代替了系统的title提示。"
        :apiList="api"
    >
        <ComponentExample
...
import Directive from '@/examples/tooltip/Directive.vue?demo'
